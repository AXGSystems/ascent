...
export default function DriftGuardPage() {
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      {/* Hero */}
      <section>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-amber-600 via-orange-600 to-brand-navy p-6 md:p-8 shadow-lg shadow-amber-600/10">
