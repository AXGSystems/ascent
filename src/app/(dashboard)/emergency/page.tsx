      ...
      <section>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-teal via-brand-teal-dark to-brand-navy p-4 md:p-6 lg:p-8 shadow-lg shadow-brand-teal/10">
          ...
          <div className="relative flex flex-col items-center text-center">
            ...
            <p className="text-3xl md:text-4xl lg:text-5xl font-black text-white tabular-nums"><CountUp value={coverage} decimals={1} /><span className="text-lg font-normal text-white/50"> months</span></p>
