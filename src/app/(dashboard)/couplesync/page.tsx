...
export default function CoupleSyncPage() {
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      {/* Hero */}
      <section>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-pink-600 via-rose-500 to-brand-navy p-4 md:p-6 lg:p-8 shadow-lg shadow-pink-600/10">
