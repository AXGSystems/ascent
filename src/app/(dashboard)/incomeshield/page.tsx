...
export default function IncomeShieldPage() {
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      {/* Hero */}
      <section>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-600 via-cyan-600 to-brand-navy p-4 md:p-6 lg:p-8 shadow-lg shadow-teal-600/10">
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="shrink-0 text-center">
              ...
              <p className="text-3xl md:text-4xl lg:text-5xl font-black tabular-nums text-white"><CountUp value={stabilityScore} /></p>
