...
export default function CreditPage() {
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      {/* Hero */}
      <section>
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-brand-green via-brand-teal to-brand-navy p-4 md:p-6 lg:p-8 shadow-lg shadow-brand-green/10">
